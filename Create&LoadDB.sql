...
-- Create the tables with its respective key restrains.
-- 1
...
CREATE TABLE book_info(
  ...
  book_cover              VARCHAR(255) NOT NULL, -- directory location of the image or text
...
-- Insert the values in the order where Forein Keys wont be a problem
-- 1
